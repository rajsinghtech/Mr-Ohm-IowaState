...
class Builder:
    ...
    def _initialize_rom_software(self):
        ...
        # Get BIOS data from compiled BIOS binary.
        # app_file = os.path.join(self.software_dir, "application", "app.bin")
        # app_data = soc_core.get_mem_data(app_file, self.soc.cpu.endianness)

        # Initialize SoC with with BIOS data.
        # self.soc.initialize_rom(app_data)
        # self.soc.init_rom(name="application_software", contents=data)

    def build(self, application_path, **kwargs):
        ...
        # self.add_software_package('app', application_path)
        # self.add_software_library('app')
